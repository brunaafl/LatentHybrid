...
for type in "${types[@]}"; do
	...
	--command -- /usr/bin/python /project/src/Bruna/script_moabb_exp2.py --config_file=/project/config/config.yaml --num_exp 'exp_2' --dataset ${dataset} --ea ${type}
    done
done
